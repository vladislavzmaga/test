		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse">
		      <ul class="nav navbar-nav">
		        <li class="dropdown-item"><a href="#" class="dropdown-link">Кабінет </a>
			<div class="form-wrapper">
				<ul class="form-list">
					<li class="form-item">
						<a href="#" class="form-link">First Name</a>
						
					</li>
					<li class="form-item">
						<a href="#" class="form-link">Settings</a>
					</li>
			...
			<div class="form-box">
				<form class="form">
					<label  class="form-lable">
						Label
						<input type="text" name="lable" class="form-input"/>
					</label>
					<label class="form-lable">
						Placeholder
						<input type="text" name="plceholder" class="form-input"/>
					</label>
					<label class="form-lable">
						Require
						<input type="checkbox" name="require" id="input-check" class="input-check visually-hidden"/>
						<span class="checkbox-span"><img src="./img/checbox-checked.svg" class="check-icon" width="11" height="8"/></span>
					</label>
				</form>
			</div>
			</div>
		        ...
		        <li class="dropdown dropdown-item">
		          <a href="#" class="dropdown-toggle dropdown-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Категорії <span class="caret rotate-menu"></span></a>
		          <ul class="dropdown-menu">
					 <?php
									foreach ($categories as $category) {
										?>
											<li class="dropdown-item-top"><a href="#" class="dropdown-link-top"><?php echo $category;?> 
										<?php
										if($category === 'Комп`ютери'){
											?>
											<span class="caret rotate-bottom"></span>
												<ul class="dropdown-list">
													<?php
													foreach ($sub_categories as $sub_category) {
														?>
														<li class="dropdown-item-bottom"><a href="#" class="dropdown-link-bottom">
															<?php
															 echo $sub_category;
															 ?>
															 </a></li>
